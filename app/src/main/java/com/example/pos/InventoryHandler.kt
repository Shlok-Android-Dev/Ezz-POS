...
class InventoryHandler(var context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, 3){
    override fun onCreate(db: SQLiteDatabase?) {
        val createTable = "CREATE TABLE " + TABLE_NAME +" (" + COL_ID +" INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_ITEMCODE + " VARCHAR(20), " + COL_ITEMNAME + " VARCHAR(100), " + COL_COST + " FLOAT, " + COL_QUANTITY + " FLOAT, " + COL_TOTAL + " FLOAT, " + COL_STOCK + " FLOAT)"
         Log.d("Querry>>", "onCreate: $createTable")
